...
const HTTP_LOG = (detail: Record<HTTP_LOGIF, string> & Record<'status', number>): JSX.Element => (
  <>
...
const RESOURCE_ERROR = (detail: Record<RESOURCE, string>): JSX.Element => (
  <>
...
const OPERATION = (detail: Record<OPERATIONIF, string>): JSX.Element => (
  <>
